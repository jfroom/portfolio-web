...
var Config = (function () {
    ...
    Config.getConfigFile_ = function () { return path.resolve(Config.dir, '..', Config.configFile); };
    Config.getPackageFile_ = function () { return path.resolve(Config.dir, '..', Config.packageFile); };
    Config.getSeleniumDir = function () { return path.resolve(Config.dir, '..', '..', 'selenium/'); };
    Config.getBaseDir = function () { return path.resolve(Config.dir, '..', '..'); };
    /**
