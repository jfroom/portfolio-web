...
var ProtractorExpectedConditions = (function () {
    ...
    ProtractorExpectedConditions.prototype.alertIsPresent = function () {
        return function () {
            return global.browser.driver.switchTo().alert().then(function () { return true; }, function (err) {
    ...
    ProtractorExpectedConditions.prototype.titleIs = function (title) {
        return function () {
            return global.browser.driver.getTitle().then(function (actualTitle) { return actualTitle === title; });
        };
    };
    /**
    ...
    ProtractorExpectedConditions.prototype.urlIs = function (url) {
        return function () {
            return global.browser.driver.getCurrentUrl().then(function (actualUrl) { return actualUrl === url; });
        };
    };
    /**
